...
const About = () => {
  return (
    <section id="about" data-testid="about-section" className="relative py-24 md:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <StaggerContainer staggerChildren={0.15} className="mt-14 grid md:grid-cols-2 gap-6">
          <StaggerItem direction="up">
            <div data-testid="mission-card" className="surface-card p-8 md:p-10 hover:border-[#9B59D0]/50 transition-colors">
              ...
              <p className="mt-4 text-white/60 leading-relaxed text-sm md:text-base line-clamp-2">
          ...
          <StaggerItem direction="up">
            <div data-testid="vision-card" className="surface-card p-8 md:p-10 hover:border-[#FBBF24]/50 transition-colors">
