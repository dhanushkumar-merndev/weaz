...
const ProgramsOrbit = ({ onEnroll }: ProgramsOrbitProps) => {
  return (
    <section id="programs" data-testid="programs-orbit-section" className="relative py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative mt-16 md:mt-24 mx-auto" style={{ maxWidth: 900 }}>
          <div className="relative aspect-square">
            ...
            <div className="absolute inset-[18%] rounded-full border border-dashed border-[#9B59D0]/25 orbit-ring" />

            {/* Center */}
            <div className="absolute inset-[30%] rounded-full bg-gradient-to-br from-[#9B59D0]/25 via-[#0F0B14] to-[#FBBF24]/15 border border-white/10 grid place-items-center">
            ...
            {nodes.map((n, idx) => {
              ...
              return (
                <button
                  ...
                  className="absolute -translate-x-1/2 cursor-pointer group z-20"
                  style={{
                    ...style,
                    transform:
                      idx === 0
                ...
                >
                  <div className="surface-card p-4 md:p-5 w-40 md:w-56 text-left hover:border-white/20">
                    <div
                    ...
                    <div className="font-display text-sm md:text-base font-bold leading-tight text-white">
                      {n.title}
                    </div>
