...
const FinalCTA = ({ onEnroll }: FinalCTAProps) => {
  return (
    <section data-testid="final-cta-section" className="relative py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative surface-card p-8 md:p-16 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {steps.map((s, idx) => (
                <div
                  ...
                  className="relative p-5 rounded-2xl border border-white/10 bg-white/[0.02]"
                >
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <button
                ...
                onClick={onEnroll}
                className="pill-gold px-8 py-4 inline-flex items-center gap-2 text-base cursor-pointer"
              >
